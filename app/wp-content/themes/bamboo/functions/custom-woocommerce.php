...
function custom_override_checkout_fields($fields)
{
  ...
  /*$city_args = wp_parse_args( array(
        ...
        'options' => array(
            ...
            "Красноперекопськ (Яни Капу)" => "Красноперекопськ (Яни Капу)",
            "Кременець" => "Кременець",
            "Кременчук" => "Кременчук",
            "Кремінна" => "Кремінна",
...
/*
  ...
  */
    ...
    //$adresa='Адреса доставки (вулиця, номер будинку)';
    $adresa = 'Доставка (номер відділення/індекс, або ж адреса для курʼєрської доставки)';
    $company = 'Коментар';
    /*		$city='Місто';
		$region='Область';*/
  ...
  $fields['billing']['billing_last_name']['placeholder'] = $last_name;
  $fields['billing']['billing_last_name']['label'] = $last_name;
  ...
  /*    $fields['billing']['billing_city'] = $city_args;
    ...
    $fields['billing']['billing_state'] = $region_args;
